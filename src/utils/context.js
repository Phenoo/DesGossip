...
const AppProvider =  ({ children }) => {
  ...
  const url = `https://gnews.io/api/v4/search?q=${searchItem}&lang=en&token=489ea78a28682b7b4760f55ad150238a`
  ...
  return (
    <AppContext.Provider 
    value={{searchItem, setsearchItem, newsdata, setNewsData, loading, err, setErr}}
    >
      {children}
    </AppContext.Provider>
  )
